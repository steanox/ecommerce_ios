...
//  ecommerce
//
//  Created by Octavianus Gandajaya on 9/11/17.
...
class Product{
    ...
    init(uid: String?, name: String?,images: [UIImage]?, price: Double?, description: String?, detail: String?, relatedProductUid: [String]? = []) {
        self.uid = uid
        self.name = name
        self.images = images
        self.price = price
